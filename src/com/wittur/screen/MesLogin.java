...
public class MesLogin extends JFrame {
	...
	public MesLogin() {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if("admin".equals(user.getText()) && "wittur123".equals(password.getText())){
					MesManager m = new MesManager();
					m.setVisible(true);
					dispose();
				}else{
